...
subtitle: "WS 2021/2022 R-Übung 3: Regressionsmodelle in R"
...
![Lineare Regression. Quelle: Vorlesung ](figures/LineareRegression.jpg){width=70%}
...
![Logistische Regression. Quelle: Wikipedia ](figures/LogistischeRegression.jpg){width=70%}
...
![Proportional Odds Regression. Quelle: Schlarmann, Galatsch, 2014 ](figures/PropOddsRegression){width=70%}
...
![Proportional Odds Regression. Quelle: wikipedia ](figures/NichtLineareRegression.jpg){width=70%}

## Aufgabe 3: Nichtlineare Regression

```{r A3, echo=FALSE, warning=FALSE, message=FALSE}
loaded2<-load("data2/MichMenten.RData")
vmaxA<-max(myDat$vA)
kmA<-vmaxA/2
...
* Lineare & logistische Regression sind in den meisten Analysesoftware enthalten, prop. Odds nicht (daher auch recht selten --> Annahme pseudo-linear --> lin. Regression)
